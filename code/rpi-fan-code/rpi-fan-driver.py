...
# Configuration
FAN_PIN = 22  # Pin used. Change if not using pin 21. BCM numbering is used
...
if len(speedSteps) != len(tempSteps):
    print("Numbers of temperature steps and speed steps are different")
    exit(0)
